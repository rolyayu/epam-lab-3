...
public class SweetXMLValidator extends DefaultHandler {
    public static final String SCHEMA_FILE_NAME = "resource" + File.separator + "sweets.xsd";

    private StringBuilder error = new StringBuilder();

    private final String fileName;

    public SweetXMLValidator(String fileName) {
